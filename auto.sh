...
init(){
    new_tab "karma start"
    browserify test-bots/async-bot.js | testling -x "open -a /Applications/Google\ Chrome.app"
}
...
#   Darwin)
#     OS='Mac'
#     get_test "/Applications/Google\ Chrome.app/Contents/MacOS/Google\ Chrome --use-fake-ui-for-media-stream";
#     ;;
#   AIX) ;;
